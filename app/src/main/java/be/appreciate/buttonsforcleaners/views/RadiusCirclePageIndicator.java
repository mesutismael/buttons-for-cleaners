 ...
 */
public class RadiusCirclePageIndicator extends View implements PageIndicator
{
    ...
    public RadiusCirclePageIndicator(Context context) {
        this(context, null);
    }

    public RadiusCirclePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, com.viewpagerindicator.R.attr.vpiCirclePageIndicatorStyle);
    }

    public RadiusCirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mOrientation = a.getInt(com.viewpagerindicator.R.styleable.CirclePageIndicator_android_orientation, defaultOrientation);
        mPaintPageFill.setStyle(Paint.Style.FILL);
        mPaintPageFill.setColor(a.getColor(com.viewpagerindicator.R.styleable.CirclePageIndicator_pageColor, defaultPageColor));
        mPaintStroke.setStyle(Paint.Style.STROKE);
        mPaintStroke.setColor(a.getColor(com.viewpagerindicator.R.styleable.CirclePageIndicator_strokeColor, defaultStrokeColor));
        mPaintStroke.setStrokeWidth(a.getDimension(com.viewpagerindicator.R.styleable.CirclePageIndicator_strokeWidth, defaultStrokeWidth));
        mPaintFill.setStyle(Paint.Style.FILL);
        mPaintFill.setColor(a.getColor(com.viewpagerindicator.R.styleable.CirclePageIndicator_fillColor, defaultFillColor));
        ...
        Drawable background = a.getDrawable(com.viewpagerindicator.R.styleable.CirclePageIndicator_android_background);
        if (background != null) {
        ...
        if(attrs != null)
        {
            TypedArray extra = context.obtainStyledAttributes(attrs, R.styleable.RadiusCirclePageIndicator, 0, 0);

            mPageRadius = a.getDimension(R.styleable.RadiusCirclePageIndicator_pageRadius, mRadius);
    ...
    public void setPageRadius(float pageRadius)
    {
        mPageRadius = pageRadius;
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float pageFillRadius = mPageRadius;
        ...
        for (int iLoop = 0; iLoop < count; iLoop++) {
            ...
            if (pageFillRadius != mPageRadius) {
                canvas.drawCircle(dX, dY, mPageRadius, mPaintStroke);
            }
        }
